...
const MyPlacesScreen = () => {
    ...
    const [places, setPlaces] = useState([{ "id": 1, "title": "Casa", "coords": {"latitude":-34.555579051686586,"longitude":-58.461540799929494},"address":"Blanco Encalada 2518, C1425 Cdad. Autónoma de Buenos Aires" },{ "id": 2, "title": "Fuera de tiempo", "coords": {"latitude":-34.54776236446238,"longitude":-58.5538693790271},"address":"Blanco Encalada 2518, C1425 Cdad. Autónoma de Buenos Aires" }])
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                ...
                <Pressable onPress={getLocation}><Icon name="location-on" color={color.naranjaBrillante} size={24} /></Pressable>
                <Pressable onPress={savePlace}><Icon name="add-circle" color={color.verdeOk} size={32} /></Pressable>
            </View>
